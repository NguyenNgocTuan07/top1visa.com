...
<table width="100%" id="wpaicg-post-form">
    ...
    <tr>
        <td>
            ...
            if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                ?>
                <input type="text" id="wpai_keywords" placeholder="e.g. battery life, cost, user friendliness" class="wpcgai_input" name="_wporg_keywords" value="<?php echo esc_html($_wporg_keywords); ?>">
                <?php
            } else{
                ?>
    ...
    <tr>
        <td>
            ...
            if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                ?>
                <input type="text" id="wpai_words_to_avoid" placeholder="e.g. top, best, click" class="wpcgai_input" name="_wporg_words_to_avoid" value="<?php echo esc_html($_wporg_words_to_avoid); ?>">
                <?php
            } else{
                ?>
                <input type="text" class="wpcgai_input" disabled placeholder="Available in Pro">
    ...
    <tr>
        <td>
            <select name="_wporg_writing_style" id="wpai_writing_style">
                ...
                ?>>Vivid</option>
                <option value="busin" <?php echo (esc_html($_wporg_writing_style) == 'busin') ? 'selected' : ''; ?>>Business</option>
                <option value="repor" <?php echo (esc_html($_wporg_writing_style) == 'repor') ? 'selected' : ''; ?>>Report</option>
                <option value="resea" <?php echo (esc_html($_wporg_writing_style) == 'resea') ? 'selected' : ''; ?>>Research</option>
            </select>
        </td>
    <tr>
    <tr>
    ...
    <tr>
        <td>
            <select name="_wporg_writing_tone" id="wpai_writing_tone">
                ...
                ?>>Sympathetic</option>
                    <option value="curio" <?php echo (esc_html($_wporg_writing_tone) == 'curio') ? 'selected' : ''; ?>>Curious</option>
                    <option value="disap" <?php echo (esc_html($_wporg_writing_tone) == 'disap') ? 'selected' : ''; ?>>Disappointed</option>
                    <option value="encou" <?php echo (esc_html($_wporg_writing_tone) == 'encou') ? 'selected' : ''; ?>>Encouraging</option>
                    <option value="optim" <?php echo (esc_html($_wporg_writing_tone) == 'optim') ? 'selected' : ''; ?>>Optimistic</option>
                    <option value="surpr" <?php echo (esc_html($_wporg_writing_tone) == 'surpr') ? 'selected' : ''; ?>>Surprised</option>
                    <option value="worry" <?php echo (esc_html($_wporg_writing_tone) == 'worry') ? 'selected' : ''; ?>>Worried</option>
            </select>
        </td>
    <tr>
    <tr>
        <td><label style="font-weight: bold;" for="label_img"><?php echo  esc_html( __( "Image Source", "wp-ai-content-generator" ) ) ; ?></label></td>
    </tr>
    <tr>
        <td>
            <select class="regular-text" id="wpaicg_image_source" name="wpaicg_image_source" >
                <option value="">None</option>
                <option<?php echo $wpaicg_image_source == 'dalle' || ($wpaicg_image_source == 'pexels' && empty($wpaicg_pexels_api)) ? ' selected' : ''?> value="dalle">DALL-E</option>
                <option<?php echo !empty($wpaicg_pexels_api) && $wpaicg_image_source == 'pexels' ? ' selected':'';?><?php echo empty($wpaicg_pexels_api) ? ' disabled':''?> value="pexels">Pexels</option>
            </select>
        </td>
    </tr>
    <tr>
        <td><label style="font-weight: bold;" for="label_img"><?php echo  esc_html( __( "Featured Image Source", "wp-ai-content-generator" ) ) ; ?></label></td>
    </tr>
    <tr>
        <td>
            <select class="regular-text" id="wpaicg_featured_image_source" name="wpaicg_featured_image_source" >
                <option value="">None</option>
                <option<?php echo $wpaicg_featured_image_source == 'dalle' || ($wpaicg_featured_image_source == 'pexels' && empty($wpaicg_pexels_api)) ? ' selected' : ''?> value="dalle">DALL-E</option>
                <option<?php echo !empty($wpaicg_pexels_api) && $wpaicg_featured_image_source == 'pexels' ? ' selected':'';?><?php echo empty($wpaicg_pexels_api) ? ' disabled':''?> value="pexels">Pexels</option>
            </select>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            ...
            <select class="regular-text" id="wpaicg_pexels_orientation" name="wpaicg_pexels_orientation" >
                <option value="">None</option>
                <option<?php echo strtolower($wpaicg_pexels_orientation) == 'landscape' ? ' selected':''?> value="landscape">Landscape</option>
                <option<?php echo strtolower($wpaicg_pexels_orientation) == 'portrait' ? ' selected':''?> value="portrait">Portrait</option>
                <option<?php echo strtolower($wpaicg_pexels_orientation) == 'square' ? ' selected':''?> value="square">Square</option>
            </select>
        </td>
    </tr>
    <tr>
        <td>
            ...
            <select class="regular-text" id="wpaicg_pexels_size" name="wpaicg_pexels_size" >
                <option value="">None</option>
                <option<?php echo strtolower($wpaicg_pexels_size) == 'large' ? ' selected':''?> value="large">Large</option>
                <option<?php echo strtolower($wpaicg_pexels_size) == 'medium' ? ' selected':''?> value="medium">Medium</option>
                <option<?php echo strtolower($wpaicg_pexels_size) == 'small' ? ' selected':''?> value="small">Small</option>
            </select>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_intro_title_tag"><?php echo  esc_html( __( "Intro Title Tag", "wp-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <label class="wpaicg-form-label" for="wpaicg_conclusion_title_tag"><?php echo  esc_html( __( "Conclusion Title Tag", "wp-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_toc"><?php echo  esc_html( __( "Table of Content?", "wp-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_toc_title"><?php echo  esc_html( __( "ToC Title", "wp-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_toc_title_tag"><?php echo  esc_html( __( "ToC Title Tag", "wp-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_seo_meta_desc"><?php echo  esc_html( __( "Meta Description?", "wp-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_seo_meta_desc"><?php echo  esc_html( __( "Tags", "wp-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            ...
            <div class="wpaicg-tabs">
                <ul>
                    <li id="wpaicg-seo-tab-content" data-target="wpaicg-tab-generated-text" class="wpaicg-active<?php echo !empty($_wporg_generated_text) ? ' wpaicg-has-seo' : ''?>">Content</li>
                    <li id="wpaicg-seo-tab-item" data-target="wpaicg-seo-tab" class="<?php echo !empty($wpaicg_post_excerpt) ? 'wpaicg-has-seo' : ''?>">SEO</li>
                </ul>
