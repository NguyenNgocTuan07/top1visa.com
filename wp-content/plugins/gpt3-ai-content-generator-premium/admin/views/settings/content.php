...
<div id="tabs-2">
    ...
    <div class="wpcgai_form_row">
        ...
        <select class="regular-text" id="label_wpai_writing_style" name="wpaicg_settings[wpai_writing_style]" >
            ...
            ?>>Vivid</option>
            <option value="busin" <?php echo (esc_html($existingValue['wpai_writing_style']) == 'busin' ? 'selected' : '' );?>>Business</option>
            <option value="repor" <?php echo (esc_html($existingValue['wpai_writing_style']) == 'repor' ? 'selected' : '' );?>>Report</option>
            <option value="resea" <?php echo (esc_html($existingValue['wpai_writing_style']) == 'resea' ? 'selected' : '' );?>>Research</option>
        </select>
    ...
    <div class="wpcgai_form_row">
        ...
        <select class="regular-text" id="label_wpai_writing_tone" name="wpaicg_settings[wpai_writing_tone]" >
            ...
            ?>>Sympathetic</option>
                <option value="curio" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'curio' ? 'selected' : '' );?>>Curious</option>
                <option value="disap" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'disap' ? 'selected' : '' );?>>Disappointed</option>
                <option value="encou" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'encou' ? 'selected' : '' );?>>Encouraging</option>
                <option value="optim" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'optim' ? 'selected' : '' );?>>Optimistic</option>
                <option value="surpr" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'surpr' ? 'selected' : '' );?>>Surprised</option>
                <option value="worry" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'worry' ? 'selected' : '' );?>>Worried</option>
        </select>
