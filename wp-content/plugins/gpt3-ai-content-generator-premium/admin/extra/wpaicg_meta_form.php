...
<div class="wpaicg_grid_form" id="wpaicg-post-form">
    <div class="wpaicg_grid_form_2">
        <div class="mb-5">
            <input type="text" id="wpai_preview_title" placeholder="Title: e.g. Mobile Phones" class="wpaicg-input" name="_wporg_preview_title" value="<?php echo  esc_html( $_wporg_preview_title ) ; ?>">
        </div>
        <div class="mb-5">
        ...
        <div class="mb-5">
            <div class="wpaicg-tabs">
                <ul>
                    ...
                    <li id="wpaicg-seo-tab-item" data-target="wpaicg-seo-tab" class="<?php echo !empty($post->post_excerpt) ? 'wpaicg-has-seo' : ''?>">SEO</li>
                </ul>
            ...
            <div class="wpaicg-collapse-content">
                <div class="mb-5">
                    ...
                    if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                        ?>
                        <input type="text" id="wpai_keywords" placeholder="e.g. battery life, cost, user friendliness" class="wpcgai_input" name="_wporg_keywords" value="">
                        <?php
                    } else{
                        ?>
                ...
                <div class="mb-5">
                    ...
                    if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                        ?>
                        <input type="text" id="wpai_words_to_avoid" placeholder="e.g. top, best, click" class="wpcgai_input" name="_wporg_words_to_avoid" value="">
                        <?php
                    } else{
                        ?>
                        <input type="text" class="wpcgai_input" disabled placeholder="Available in Pro">
        ...
        <div class="wpaicg-collapse">
            ...
            <div class="wpaicg-collapse-content">
                ...
                <div class="mb-5">
                    ...
                    if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                        ?>
                        <input type="checkbox" id="wpai_add_faq2" name="_wporg_add_faq2" class="wpai-content-title-input" value="1"/>
                ...
                <div class="mb-5">
                    ...
                    ?>
                    <label class="wpaicg-form-label" for="wpaicg_toc"><?php echo  esc_html( __( "Add Table of Contents?", "wp-ai-content-generator" ) ) ;?></label>
