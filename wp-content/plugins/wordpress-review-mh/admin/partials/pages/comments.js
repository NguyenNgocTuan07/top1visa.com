            ...
            <div class="order-top q-pa-sm">
                <div class="flex-dp fz-12">
                    <div class="buyer-info">
                        ...
                        <q-chip  icon="phone" v-if="record.customer_phone"> {{record.customer_phone}}  </q-chip>
                        <q-chip  icon="email" v-if="record.customer_email"> {{record.customer_email}}  </q-chip>
                        <q-chip >  {{record.created_at}}  </q-chip>
                    </div>
            ...
            <div class="order-body flex-dp">
                ...
                <div class="total-cost q-pa-md">
                    ...
                    <div class="comment-photos q-gutter-xs q-mt-xs">
                        ...
                        <q-img v-for="(img, i) in record.attactments" :key="record.id + i" round :src="srcImg(img)" :ratio="1" width="40px" @click="openLightbox(record.attactments, record.id)"/>
...
export default {
  ...
  created(){
    ...
    this.$eventBus.$emit('set.page_title', 'Quản lý bình luận');
