		...
		<div class="customer-comments wp-ajax-content" data-type="2">
				...
				<div class="customer-comment__item parent-reply-item" itemprop="mainEntity" itemscope="" itemtype="https://schema.org/Question">
					...
					<div class="customer-comment__content" itemprop="name">
					...
					<div class="customer-comment__action">
						...
						<a href="javascript:void(0)" class="time"><?php echo htmlentities($review->date) ?> </a>
					</div>
			        ...
			        <div class="listreply">
	        			<div class="review-comment__sub-comments">
	        	            ...
	        	            <div class="style__StyledSubComment-sc-103p4dk-6 fKaYwj review-sub-comment parent-reply-item" itemprop="acceptedAnswer" itemscope="" itemtype="https://schema.org/Answer">
	        	                ...
	        	                <div class="review-sub-comment__inner">
	        	                    <div class="review-sub-comment__avatar">
	        	                        ...
	        	                        <div class="customer-comment__item-name"><?php echo $child->is_admin_message == '1' ? $settings['admin']['name'] : htmlentities($child->customer_name) ?></div>
	        	                    ...
	        	                    <div class="customer-comment__content" itemprop="text">
