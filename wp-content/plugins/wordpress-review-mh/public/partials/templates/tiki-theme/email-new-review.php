                                ...
                                >
                                    <div >
                                        ...
                                        <p
                                            ...
                                            "
                                        >
                                            <span style="display: inline-block; width: 120px; font-weight: bold;">IP:</span> <?php echo $ip ?>
                                        </p>
                                        ...
                                        <p
                                            ...
                                            "
                                        >
                                            <span style="display: inline-block; width: 120px; font-weight: bold;">Trang đích:</span> <a href="<?php echo get_the_permalink($post_id); ?>"><?php echo get_the_title($post_id) ?></a>
                                        </p>
                                        <p
                                            style="
                                                color: #444;
