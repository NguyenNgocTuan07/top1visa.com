<h3 class="wp-review-mh__title">Hỏi đáp</h3>

<div class="wp-comments-box">
	<div class="customer-reviews__inner">
		<textarea name="" id="" cols="30" rows="4" class="comments-input_message" placeholder="Hãy viết bình luận của bạn tại đây."></textarea>
		...
		<!-- <br>
		<span class="totalcomment">2.239 bình luận</span>
		<hr> -->
		<div class="customer-comments">

			<div class="customer-comment__item">
				<div class="customer-comment__item-user">
					<div class="review-sub-comment__avatar-thumb">
	                    <div class="Avatar__StyledAvatar-sc-17zdycl-0 gDQSLG has-character" data-name="Nguyễn Văn A">
	    					<span></span>
	                    </div>
		            </div>
		            <div class="customer-comment__item-name">
			            <span>Đỗ Minh Hải</span>
				...
				<div class="customer-comment__action" data-cl="0">
					...
					<a href="javascript:void(0)" class="time">9 giờ trước </a>
				</div>
        	            ...
        	            <div class="style__StyledSubComment-sc-103p4dk-6 fKaYwj review-sub-comment">
        	                ...
        	                <div class="review-sub-comment__inner">
        	                    <div class="review-sub-comment__avatar">
        	                        <div class="review-sub-comment__avatar-name">Nguyễn Văn A</div>
        	                        
        	                        <div class="review-sub-comment__avatar-date">12/05/2021 20:48</div>
        	                        <!-- <div class="review-sub-comment__avatar-date">19 tháng 01, 2021</div> -->
        	                    </div>
        	                    <div class="review-sub-comment__content">
        	                            <span>Sản phẩm chất lượng bình thường, tạm ổn.</span>
			        			...
			        			<div class="review-comment__sub-comments">
			        	            ...
			        	            <div class="style__StyledSubComment-sc-103p4dk-6 fKaYwj review-sub-comment">
			        	                ...
			        	                <div class="review-sub-comment__inner">
			        	                    <div class="review-sub-comment__avatar">
			        	                    	<div class="review-sub-comment__avatar-thumb">
			        	                    		                    <div class="Avatar__StyledAvatar-sc-17zdycl-0 gDQSLG" data-name="Nguyễn Văn A">
			        	                    		    					<img src="http://localhost/affiliate-woo/wp-content/uploads/2021/03/14708156_1861294444099532_8999849426570778930_n.jpg" alt="Tiki Care">
			        	                    		                    </div>
			        	                    			            </div>
			        	                        <div class="review-sub-comment__avatar-name">Nguyễn Văn A</div>
			        	                    ...
			        	                    <span data-view-id="pdp_product_review_like_buton" class="review-comment__thank" data-id="12">
			        	                    ...
			        	                    <span data-view-id="pdp_product_review_reply_button" class="review-comment__reply" data-reply-id="11">Gửi trả lời</span>
			        	                </div>
			        	            </div>
