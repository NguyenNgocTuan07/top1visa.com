...
<div class="notice notice-warning is-dismissible">
    <p><?php echo sprintf( esc_html__( 'Cannot activate %1$s%2$s%3$s. MonsterInsights PRO addon works with a valid and active licenses only.', 'monsterinsights' ), '<strong>', $addon_data->title, '</strong>' ); ?>
    </p>
</div>
<?php
							}
